...
public class ItemUtils {
    ...
    /**
     * Get the corresponding item stack according to the number of coins.
     * Referenced the code of <a href="https://github.com/Moulberry/NotEnoughUpdates/blob/master/src/main/java/io/github/moulberry/notenoughupdates/util/ItemUtils.java">NEU</a>.
     *
     * @param coinAmount amount of coins
     * @return ItemStack
     */
    public static ItemStack getCoinItemStack(long coinAmount) {
        ...
        try {
            return ItemStack.fromNbt(StringNbtReader.parse(String.format("{id:\"minecraft:player_head\",Count:1,tag:{display:{Name:\"[{\\\"text\\\":\\\"%s Coins\\\",\\\"color\\\":\\\"gold\\\",\\\"italic\\\":false}]\"},SkullOwner:{Id:\"%s\",Properties:{textures:[{Value:\"%s\"}]}}}}", NumberFormat.getInstance(Locale.US).format(coinAmount), uuid, texture)));
        } catch (CommandSyntaxException e) {
            throw new RuntimeException(e);
        }
    }

    public static ItemStack getKatStack() {
        try {
            return ItemStack.fromNbt(StringNbtReader.parse("{id:\"minecraft:player_head\",Count:1,tag:{SkullOwner:{Id:\"62413bed-116b-20d5-bfd7-af550e6d081c\",Properties:{textures:[{Value:\"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHBzOi8vdGV4dHVyZXMubWluZWNyYWZ0Lm5ldC90ZXh0dXJlL2VhYWU4MTI3NzU3MDZiNTY1OTY2ODM0ODZhYmVhZjg1N2VhMWMwNjhjYjM0YThiYzFkZTlhNTdjNjM4Y2Y0MTEifX19\"}]}}}}"));
        } catch (CommandSyntaxException e) {
            throw new RuntimeException(e);
        }
    }
